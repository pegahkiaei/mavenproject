...
<div class=" ui right aligned header style-header">
	...
	<div class="ui horizontal list style-header">
		...
		<div id="topM" class="ui secondary floating dropdown  button">
			...
			&nbsp گزينه ها
			<div class="menu">
				<a class="yellow item" href="profFirstPage.html">صفحه اعلان ها</a>
				<a class="active yellow item" href="#">مشاهده و ویرایش پروفایل</a>
...
<div class="container pusher style-container" >
	...
	<div class=" style-content">
		...
		<div class="eight wide centered column">
			<form class="ui small form" action="/profLogin/infoEdit" method="POST">
