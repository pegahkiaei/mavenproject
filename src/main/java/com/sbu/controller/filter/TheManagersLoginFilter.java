 ...
 */
@WebFilter("/themanagers/*")/*check for all urls */
public class TheManagersLoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws ServletException, IOException {
        ...
        String loginURI = request.getContextPath() + "/themanagers"; /* student login page */
        String stuFirstPage = request.getContextPath() + "/themanagers/login"; /* student login page */
        //String mainPage = request.getContextPath() + "/"; /* ?! */

        boolean loggedIn = (session != null) && (session.getAttribute("type") != null) && (session.getAttribute("type") == "m");
        ...
        if (loggedIn || loginRequest||isStaticResource || isFirstPage) { //if: user is logged in, or user is attempting to login, or user is just looking at the main page and has nothing to do with us
            ...
            System.err.println("!@!@!@!@!@!@!@!@!@!@!@!@!@!@!@!@!@!@" + request.getRequestURI() + isFirstPage + loginRequest );
