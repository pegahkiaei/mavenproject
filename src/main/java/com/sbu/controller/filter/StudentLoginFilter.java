...
public class StudentLoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws ServletException, IOException {
        ...
        String stuFirstPage = request.getContextPath() + "/studentLogin/login"; /* student login page */
        ...
        if (loggedIn || loginRequest||isMainPage||isStaticResource || isFirstPage) { //if: user is logged in, or user is attempting to login, or user is just looking at the main page and has nothing to do with us
