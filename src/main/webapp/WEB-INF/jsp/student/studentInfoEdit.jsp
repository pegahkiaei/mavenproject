...
<button class="ui secondary button">
  ...
  <div id="topM" class="ui secondary floating dropdown  button">
	...
	&nbsp گزينه ها
    <div class="menu">
      <a class="olive item" href="studentFirstPage.jsp">صفحه اعلان ها</a>
	  <a class="active olive item" href="/student/InfoEdit">مشاهده و ويرايش پروفايل</a>
	  <a class="olive item" href="/student/transcript">مشاهده کارنامه</a>

	  <a class="olive item" href="/student/transcript">انتخاب واحد</a>
	...
	<div class="container pusher style-container" >
	  ...
	  <div class=" style-content">
		   ...
		   <div class="eight wide centered column">
            <form class="ui small form" action="/student/infoEdit" method="post">
		...
		<div class="field">
		 ...
		 <div class="field">
			...
			<button class="ui olive button" type="submit">تایید</button>
